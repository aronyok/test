 ...
 */
public abstract class AdMoodsGenres extends RecyclerView.Adapter<AdMoodsGenres.MyViewHolder> {
    ...
    public AdMoodsGenres(Context context){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view=inflater.inflate(R.layout.row_moods_genres,parent,false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            imgCover=(ImageView)itemView.findViewById(R.id.img_moods_albums);
            //imgOption=(ImageView)itemView.findViewById(R.id.img_new_release_options);

            tvTitle=(TextView)itemView.findViewById(R.id.tv_moods_title);
