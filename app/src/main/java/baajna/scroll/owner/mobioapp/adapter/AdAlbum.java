 ...
 */
public abstract class AdAlbum extends RecyclerView.Adapter<AdAlbum.MyViewHolder> {
    ...
    public AdAlbum(Context context){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view=inflater.inflate(R.layout.row_albums,parent,false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            layoutOption= (LinearLayout) itemView.findViewById(R.id.lay_new_release_options);
