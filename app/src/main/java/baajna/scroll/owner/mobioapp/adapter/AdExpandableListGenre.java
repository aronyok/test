 ...
 */
public class AdExpandableListGenre extends BaseExpandableListAdapter {


    private Context _context;
    private final MoSong moSong;
    ...
    public AdExpandableListGenre(Context context, MoSong moSong, List<MoSong> listDataHeader, HashMap<String, List<String>> listDataChild) {
